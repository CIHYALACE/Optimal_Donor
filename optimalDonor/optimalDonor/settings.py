"""
Django settings for optimalDonor project.
...
SECRET_KEY = 'django-insecure-vtj$1lm7ed3o89x7&)wwcc%nu5!uii2shm1n%jh$0e)))qr6&9'
...
ROOT_URLCONF = 'optimalDonor.urls'
...
WSGI_APPLICATION = 'optimalDonor.wsgi.application'
...
DEFAULT_FROM_EMAIL = f"Optimal Donor <{os.getenv('DEFAULT_FROM_EMAIL')}>"
