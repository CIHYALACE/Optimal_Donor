...
export default function CampaignCreationPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.category_id) errors.category_id = 'Category is required';  // Changed from category to category_id
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(formData).forEach(key => {
      if (key === 'images') {
        ...
        // Map category_id to category (backend expects 'category')
        campaignData.append('category', formData.category_id);
      } else {
